---
title: Preparing the wild-type chimera dataset for _ExperimentHub_
...
Wild-type cells (with for the addition of a fluorescent construct) were injected into wild-type embryos, to identify baseline effects from the generation of chimeras.
